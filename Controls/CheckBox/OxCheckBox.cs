...
namespace OxLibrary.Controls
{
    public class OxCheckBox : CheckBox, IOxControl<CheckBox>
    {
        ...
        public OxCheckBox()
        {
            manager = OxControlManager.RegisterControl<CheckBox>(this, OnSizeChanged);
            DoubleBuffered = true;
        }
        ...
        public void RealignControls(OxControlDockType dock = OxControlDockType.Unknown) =>
            manager.RealignControls(dock);
